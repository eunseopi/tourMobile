...
import { MapHud, RADIUS_OPTIONS } from "./components/MapHud";
  ...
  return (
    <View style={styles.container}>
      ...
      <MapHud
        ...
        stepsText={pathStats.formatSteps()}
      ...
      <MapBottomSheet
        isLoading={nearby.isLoading || search.isLoading}
        selectedItem={selectedItem}
        searchText={searchText}
        filteredMarkers={filteredMarkers}
        onOpenSelected={handleOpenSelected}
        onWriteSpot={handleWriteSpot}
